            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        <img width="32" className="rounded-full icon-glow" src="/img/WebPp.png"/>
                        <p className=" font-extrabold ml-1 text-2xl"> SarpPro </p>
                    </div>
...
const Header = ({ $, NavItems }) => {
    ...
    const colorsThemes = [
        { id: 'violet', color: 'violet', label: 'Tema¹' },
        { id: 'blue', color: 'blue', label: 'Tema²' },
        { id: 'emerald', color: 'emerald', label: 'Tema³' },
        { id: 'rose', color: 'rose', label: 'Tema⁴' },
        { id: 'amber', color: 'amber', label: 'Tema⁵' },
    ];
                    ...
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">SarpPro</span>BOT</a>
                            </p>
                        </div>
                                ...
                                <Menu.Button>
                                    <div onClick={() => setColors(!colors)} className="bg-gradient-to-tl from-amber-500 to-amber-700 text-white w-11 h-11 rounded-xl hover:opacity-80 transition-all duration-200 relative">
                                        <div className="flex w-full h-full items-center justify-center">
                                            <i className="far fa-paint-brush text-zin-900" />
                                            {!isDiscovered && <>
